    ...
    <section className="bg-[#f7faff] pb-12 text-[#151d35]">
      <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-10">
        <div className="grid gap-8 lg:grid-cols-[1.02fr_.98fr]">
          <div className="rounded-[10px] border border-[#e8eef8] bg-white/78 p-7 shadow-[0_16px_44px_rgba(15,55,105,.06)]">
              ...
              {approachSteps.map((step, index) => {
                ...
                return (
                  <article key={step.title} className="relative">
                    ...
                    <div className="flex h-[70px] w-[70px] items-center justify-center rounded-full border border-[#d6e4ff] bg-white text-[#1767ff] shadow-[0_10px_24px_rgba(23,103,255,.12)]">
          ...
          <div className="relative overflow-hidden rounded-[10px] bg-[#020b1b] p-7 text-white shadow-[0_18px_44px_rgba(2,8,23,.22)]">
            ...
            <div className="relative">
              ...
              <div className="mt-5 text-[54px] font-black leading-none text-[#1767ff]">
                “
              </div>
              <p className="min-h-[108px] text-[18px] font-medium leading-8 text-[#e7eef9]">
                {activeTestimonial.quote}
              </p>

              <div className="mt-6 flex flex-wrap items-center justify-between gap-5">
                <div className="flex items-center gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white text-[15px] font-extrabold text-[#061326]">
                ...
                <div className="flex items-center gap-1 text-[22px] text-[#ffb525]">
                  {"★★★★★"}
                </div>
              </div>
        ...
        <div className="mt-8 overflow-hidden rounded-[10px] bg-[#020b1b] shadow-[0_18px_44px_rgba(2,8,23,.18)]">
          <div className="relative flex flex-col gap-6 px-7 py-6 text-white lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="relative flex items-center gap-6">
              <div className="flex h-[76px] w-[76px] shrink-0 items-center justify-center rounded-full border border-[#5f72ff]/55 bg-[#14227d] shadow-[0_0_34px_rgba(67,88,255,.42),inset_0_0_24px_rgba(255,255,255,.12)]">
            ...
            <div className="relative flex flex-wrap gap-4 lg:pr-8">
              <a
                href="/contact"
                className="inline-flex h-[48px] items-center justify-center gap-3 rounded-[5px] bg-[#ffb525] px-7 text-[13px] font-extrabold text-[#061326] shadow-[0_12px_28px_rgba(255,181,37,.24)] transition hover:bg-[#ffc84d]"
              >
              ...
              <a
                href="/contact"
                className="inline-flex h-[48px] items-center justify-center gap-3 rounded-[5px] border border-white/35 bg-white/5 px-7 text-[13px] font-extrabold text-white transition hover:bg-white/10"
              >
                Schedule a Call
                <PhoneCall size={16} />
              </a>
