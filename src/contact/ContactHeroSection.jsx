...
export default function ContactHeroSection() {
  return (
    <section className="relative min-h-[330px] overflow-hidden bg-[#020b1b] text-white lg:min-h-[380px]">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1440px] items-center gap-8 px-6 py-9 md:px-10 lg:grid-cols-[.9fr_1.1fr] lg:px-16">
        <div>
          ...
          <h1 className="max-w-[560px] text-[38px] font-bold leading-[1.08] tracking-normal sm:text-[50px] lg:text-[40px]">
          ...
          <div className="mt-7 grid max-w-[650px] gap-4 sm:grid-cols-3">
            {highlights.map((item) => {
