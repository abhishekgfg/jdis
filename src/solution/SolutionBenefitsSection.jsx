  ...
  return (
    <section className="bg-white py-8">
      <div className="mx-auto px-6 lg:px-12">
        <div className="overflow-hidden rounded-xl bg-[#031027] px-7 py-6 text-white shadow-[0_16px_40px_rgba(2,8,23,.14)]">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-2 max-w-[360px] text-[25px] font-extrabold leading-tight text-[#071426] lg:text-[30px]">
          ...
          <div className="grid gap-x-10 gap-y-6 md:grid-cols-2 lg:border-l lg:border-[#dbe5f2] lg:pl-10">
